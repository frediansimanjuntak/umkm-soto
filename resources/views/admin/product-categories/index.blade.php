                                    ...
                                    @foreach ($productCategories as $productCategory)
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <a href="{{route('admin.product-categories.edit', $productCategory)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                                ...
                                                <x-modal name="delete-confirmation-{{$productCategory->id}}" :shows="$errors->productCategoryDeletion->isNotEmpty()" focusable>
                                                    <form action="{{route('admin.product-categories.destroy', $productCategory)}}" method="POST" class="p-6 text-center">
                                                        @csrf
                                                        @method('DELETE')
                                                        <h2>Want Delete this product category? {{$productCategory->title}}</h2>
