                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.products.product-images.update', [$product, $productImage]) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="indexing" class="block mt-1 w-full" type="number" name="indexing" :value="old('indexing', $productImage->indexing)" required autofocus autocomplete="indexing" />
