            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
                        ...
                        <div>
                            <a href="{{route('header-images.create')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add Header Image</a>
                        </div>
                    </div>
                                    ...
                                    @foreach ($headerImages as $headerImage)
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <a href="{{route('header-images.edit', $headerImage)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                                ...
                                                <x-modal name="delete-confirmation-{{$headerImage->id}}" :shows="$errors->headerImageDeletion->isNotEmpty()" focusable>
                                                    <form action="{{route('header-images.destroy', $headerImage)}}" method="POST" class="p-6 text-center">
                                                        @csrf
                                                        @method('DELETE')
