        ...
        <div class="max-w-full mx-auto">
            <div id="default-carousel" class="relative rounded-lg overflow-hidden shadow-lg" data-carousel="static">
                ...
                <div class="relative h-80 md:h-96" data-carousel-inner>
                    {{-- Loop Data Header Image --}}
                    @foreach ($headerImages as $headerImage)
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src={{$headerImage->image_url}}
                            class="object-cover w-full h-full" alt="{{$headerImage->description}}">
                        <span class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-xl font-semibold text-white md:text-2xl dark:text-gray-800">{{$headerImage->title}}</span>
                    </div>                                        
                    @endforeach
                </div>
                <!-- Slider indicators -->
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <main class="mt-2">
                        ...
                        @foreach ($productCategories as $productCategory)
                            <div class="my-2">
                                <h2 class="text-3xl font-bold dark:text-white">{{$productCategory->name}}</h2>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                @foreach ($productCategory->products as $product)
                                    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                        <a href="#">
                                            <img class="p-8 rounded-t-lg" src="{{$product->product_images->first()->image_url}}" alt="product image" />
                                        </a>
                                        <div class="px-5 pb-5">
                                            <a href="#">
